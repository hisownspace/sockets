...
def upgrade():
    ...
    with op.batch_alter_table('messages', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_messages_channel_id_rooms'), 'rooms', ['channel_id'], ['id'])
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('messages', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('fk_messages_channel_id_rooms'), type_='foreignkey')
